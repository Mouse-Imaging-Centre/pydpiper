...
def mincresample_simple(img, xfm, like, extra_flags=..., new_name_wo_ext=None, subdir=None): ...
def mincresample(img, xfm, like, extra_flags=..., new_name_wo_ext=None, subdir=None): ...

def xfmconcat(xfms, name=None): ...
def concat(ts, name=None, extra_flags=...): ...
...
def lsq6(imgs, target, lsq6_method, resolution, rotation_tmp_dir=None, rotation_range=None, rotation_interval=None, rotation_params=None): ...
