...
def LSQ12_pipeline(options):
    imgs = [MincAtom(f) for f in options.application.files]
    ...
    return lsq12_pairwise(imgs, lsq12_conf=options.lsq12,
                          lsq12_dir=options.application.output_directory or os.getcwd())
